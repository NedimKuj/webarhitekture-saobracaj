...
<head>
    ...
    <title>Minibuski saobraćaj - SAobraćaj.ba</title>
...
<body id="page-top">
    ...
    <header class="bg-primary text-white" style="background-image: url('/files/images/minibuski.png'); background-size:cover">
        <div class="container text-center">
            <h1>Minibuski saobracaj</h1>
        </div>
    </header>
        ...
        <div class="row" id="accordion">
            <div class="col">
                ...
                <div class="card">
                    ...
                    <div id="garezdelijas" class="collapse" aria-labelledby="naslov48" data-parent="#accordion">
                        <div class="card-body">
                            <p>Ruta: </p>
                ...
                <div class="card">
                    ...
                    <div id="latinskahosino" class="collapse" aria-labelledby="naslov54" data-parent="#accordion">
                        <div class="card-body">
                            <p>Ruta: </p>
                ...
                <div class="card">
                    ...
                    <div id="latinskajarcedoli" class="collapse" aria-labelledby="naslov56" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="drvenijahum" class="collapse" aria-labelledby="naslov62" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="parkbarice" class="collapse" aria-labelledby="naslov64" data-parent="#accordion">
                        <div class="card-body">
                            <p>Ruta: </p>
                ...
                <div class="card">
                    ...
                    <div id="sutjeskapoljine" class="collapse" aria-labelledby="naslov68" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="parkhrastovi2" class="collapse" aria-labelledby="naslov72" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="parkrogina" class="collapse" aria-labelledby="naslov74" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="hadzicimokrine" class="collapse" aria-labelledby="naslov76" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="ilidzamisevici" class="collapse" aria-labelledby="naslov84" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="vogoscagora" class="collapse" aria-labelledby="naslov94" data-parent="#accordion">
                        <div class="card-body">
                            <p>Ruta: </p>
                ...
                <div class="card">
                    ...
                    <div id="latinskatrebevic" class="collapse" aria-labelledby="naslov98" data-parent="#accordion">
                        <div class="card-body">
                            <p>Ruta: </p>
            ...
            <div class="col">
                ...
                <div class="card">
                    ...
                    <div id="latinskamahmutovac" class="collapse" aria-labelledby="naslov63" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="sutjeskanahorevo" class="collapse" aria-labelledby="naslov69" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="ilidzamokrine" class="collapse" aria-labelledby="naslov75" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="hadzicilokve" class="collapse" aria-labelledby="naslov77" data-parent="#accordion">
                        <div class="card-body">
                            <p>Ruta: </p>
                ...
                <div class="card">
                    ...
                    <div id="hadziciljubovcici" class="collapse" aria-labelledby="naslov79" data-parent="#accordion">
                        <div class="card-body">
                            <p>Ruta:</p>
                ...
                <div class="card">
                    ...
                    <div id="hadziciusivak" class="collapse" aria-labelledby="naslov83" data-parent="#accordion">
                        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div id="ilidzasinanovici" class="collapse" aria-labelledby="naslov85" data-parent="#accordion">
                        <div class="card-body">
                            <p>Ruta: </p>
                            <a href="/files/linije/ilidza-sabici-sinanovici.pdf"><i class="fas fa-file-pdf"></i> Preuzmi vozni red (GRAS)</a><br>
                        </div>
                    </div>
                </div>
